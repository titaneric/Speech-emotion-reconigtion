...
class CNN(nn.Module):
    def __init__(self, num_classes=4):
        ...
        self.conv1 = nn.Conv2d(1, 32, kernel_size=(14,1), stride=1, padding=0, bias=False)
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 32, kernel_size=(14,1), stride=1, padding=0, bias=False)
        self.bn2 = nn.BatchNorm2d(32)
        self.conv3 = nn.Conv2d(32, 32, kernel_size=(26,1), stride=1, padding=0, bias=False)
        self.bn3 = nn.BatchNorm2d(32)
        self.conv4 = nn.Conv2d(32, 32, kernel_size=(26,1), stride=1, padding=0, bias=False)
        self.bn4 = nn.BatchNorm2d(32)
        self.conv5 = nn.Conv2d(32, 16, kernel_size=(26,1), stride=1, padding=0, bias=False)
        self.bn5 = nn.BatchNorm2d(16)
        self.conv6 = nn.Conv2d(16, 16, kernel_size=(26,1), stride=1, padding=0, bias=False)
        self.bn6 = nn.BatchNorm2d(16)
        self.flatten = Flatten()
        self.linear1 = nn.Linear(126688,1000)
        self.dropout1 = nn.Dropout(0.1)
        self.dropout = nn.Dropout(0.2)
        self.linear2 = nn.Linear(1000, 480)
        self.linear3 = nn.Linear(480, num_classes)
...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        train_loss = 0
        data = data.view((len(data),1,32000,1))  #(B, C, H, W): (32, 1, 320, 1)
        #print(data.shape) 
...
if __name__ == "__main__":
    ...
    best_model_path = '../models/best_model_CNN_nomfcc_nonsilence_nochunk_SGD_50ms.h5'
    loss_l = []
    ...
    plt.savefig('../results/CNN_nomfcc_nonsilence_nochunk_SGD_50ms.png')
    plt.figure(2)
    plt.plot(np.arange(0, EPSIODE-1, 1), test_acc)
    plt.show()
    plt.savefig('../results/CNN_nomfcc_nonsilence_nochunk_SGD_50ms_test_acc.png')
