##############################################
# Resnet+ LSTM with additional dropout layers and relu activation function in output layer
# and additional dropout in basicblock
# Dataset: original dataset
# Preprocess: MFCC (198, 39)
##############################################
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
if __name__ == "__main__":
    ...
    plt.savefig('../results/Resnet_LSTM.png')
    plt.figure(2)
    plt.plot(np.arange(0, EPSIODE-1, 1), test_acc)
    plt.show()
    plt.savefig('../results/Resnet_LSTM_nonsilence_test_acc.png')
